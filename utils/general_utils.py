...
def get_default_pp():
    ...
    pp.allocation_mode = "proposal"
    pp.gate_train_mode = "soft_all"
    pp.gate_eval_mode = "topk"
    pp.gate_temperature_init = 1.0
    pp.gate_temperature_final = 0.2
    pp.gate_temperature_max_steps = 30_000
    ...
    pp.gate_utility_loss = False
    pp.gate_utility_lambda = 0.01
